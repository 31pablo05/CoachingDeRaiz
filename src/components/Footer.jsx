  ...
  const socialLinks = [
    {
      ...
      url: 'https://instagram.com/coachingderaiz',
    },
    {
      name: 'WhatsApp',
      icon: (
      ...
      url: 'https://wa.me/message/VPS3R5LKA4QNJ1',
    },
  ];
    ...
    <footer className="bg-gradient-to-br from-primary to-primary-deeper text-white">
      <div className="container-custom px-6 md:px-12 lg:px-20 py-12">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          {/* Brand Section */}
          <div>
            <h3 className="text-2xl font-bold mb-4">Coaching de Raíz</h3>
          ...
          <div>
            ...
            <div className="space-y-3 text-white/80">
              <p>📍 CABA y zona norte, Buenos Aires</p>
              <p>
                📧{' '}
                <a 
                  href="mailto:coachingderaiz@ejemplo.com" 
                  className="hover:text-white transition-colors"
                >
                  coachingderaiz@ejemplo.com
                </a>
              </p>
              <p>📸 @coachingderaiz</p>
            </div>
