...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'Instagram',
      hoverColor: 'hover:from-[#f09433] hover:via-[#e6683c] hover:to-[#dc2743]', // Gradiente de Instagram
      icon: (
    ...
    {
      name: 'WhatsApp',
      hoverColor: 'hover:from-[#25D366] hover:to-[#128C7E]', // Verde de WhatsApp
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8 mb-6 md:mb-8">
          ...
          <div className="space-y-3 md:space-y-4 group footer-animate opacity-0">
            <div className="relative">
              <h4 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-white group-hover:text-accent-lime transition-colors duration-500">
                Enlaces rápidos
              </h4>
          ...
          <div className="space-y-3 md:space-y-4 group footer-animate opacity-0">
            ...
            <div className="space-y-2 text-white/90">
              <div className="group/item flex items-center gap-4 p-2 md:p-3 rounded-lg hover:bg-white/10 hover:backdrop-blur-sm border border-transparent hover:border-white/20 transition-all duration-300 transform hover:scale-105 footer-card-hover">
                <div className="group-hover/item:scale-125 group-hover/item:rotate-12 transition-all duration-300 footer-glow-pulse">
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`group/social relative bg-gradient-to-br from-white/10 to-white/5 p-4 rounded-xl ${social.hoverColor} hover:text-white hover:scale-110 hover:rotate-6 transition-all duration-500 shadow-lg hover:shadow-2xl backdrop-blur-sm border border-white/20 hover:border-white/40 footer-card-hover footer-glow-pulse`}
